...
def convert_roberta_checkpoint_to_pytorch(
    ...
    config = RobertaConfig(
        ...
        max_position_embeddings=roberta.cfg.model.max_positions + 2,
        type_vocab_size=1,
    ...
    model.roberta.embeddings.LayerNorm.weight = roberta_sent_encoder.layernorm_embedding.weight # https://github.com/huggingface/transformers/issues/12670#issuecomment-878680352
