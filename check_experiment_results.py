...
from constants import experiment_configs
from pprint import pprint

tgt_dir = sys.argv[1] # e.g. topchat_kgd_test_freq-bart_small

dirs_to_check = [
    'resources/models/seed_23/results',
    'resources/models/seed_42/results',
    'resources/models/seed_1984/results',
    ]
...
for dir_path in dirs_to_check:
    ...
    for experiment in list(experiment_configs.keys()):
        summary[experiment] = {}        
